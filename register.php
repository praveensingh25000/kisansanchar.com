...
$userTypes    = $db->getUniversalRowAll($table_name='user_types',$otherfields=" and `is_active`='1'");
		...
		<form action="" method="post" id="userregistration" name="userregistration">
			...
			<div class="wdthpercent100 pT10 pB10">				
				...
				<div class="rightcontent">				
					...
					<span class="pL40">
						<input type="submit" onclick="javascript:ShowSubmitTextGlobal('submitid','reset','userregistration');" class="button" id="submitid" value="<?php echo $langVariables['form_var']['submit']?>" name="clickregister">
