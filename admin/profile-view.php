	...
	<table class="data-table">	
		<tbody>
			...
			<tr>
				...
				<th>
					<?php if(!empty($userTypes)) { ?>
						<select class="wdthpercent83 viewprofile" id="user_type" name="user_type" disabled="true">
			...
			<tr>
				...
				<th>
					<input class="viewprofile" type="text" placeholder="Enter your pincode" name="pincode" id="pincode" value="<?php if(isset($userDetail['pincode'])){ echo ($userDetail['pincode']);}?>" disabled="true"/>
				</th>
			</tr>
