<div class="wdthpercent100 pT10 pB10">	
	<form method="post" action="voice_sms_action.php" name="textsmssendingform" id="textsmssendingform" enctype="multipart/form-data">
		...
		<div class="wdthpercent100 pT10">
			<div class="wdthpercent30 left">Select Message type</div>
			<div class="wdthpercent70 left">
				<select class="wdthpercent100 required" id="sms_type" name="sms_type">
		...
		<div id="bulk_group_type_text_content"></div>
		
		<div class="wdthpercent100 pT10 pB10">
			<div class="wdthpercent30 left"> Select Message Date</div>
			<div class="wdthpercent68 left">				
				<input type="text" id="date_text" name="date" class="wdthpercent100 required">
				<script type="text/javascript">
				jQuery(document).ready(function(){jQuery('#date_text').datetimepicker({format:'Y-m-d H:i:s'});});
				</script>
			</div>
		</div>
		<div class="clear"></div>
		...
		<div class="wdthpercent100 pT10 pB10">				
			<span class="right">
			<input class="button" id="submitid" onclick="javascript:ShowSubmitTextGlobal('submitid','reset','textsmssendingform');" type="submit" value="<?php echo $langVariables['form_var']['submit']?>" name="submit">
			<input type="hidden" value="1" name="submitvoicemessage">
			<input type="hidden" id="select_upload_File" name="select_upload_type" value="txt" />
