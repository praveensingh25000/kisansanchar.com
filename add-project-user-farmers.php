...
$filterassigneduserJson  = $projectObj->getProjectAssociatedGloblaData($tablename='projects_locations',IS_PROJECT_ID,$contentType='f',$type='by_name');
			...
			<td class="wdthpercent50">
				<form id="select_content_type_form" method="post" action="">
					<select onchange="javascript: FunctionSelectContentType('select_content_type_form');" class="wdthpercent90" id="user_addition_type" name="user_addition_type">
						...
						<option <?php if(isset($_SESSION['user_addition_type']) && $_SESSION['user_addition_type']=='importcsv'){ echo 'selected="selected"';}?> value="importcsv">Import CSV Farmer Data</option>
					</select>
				</form>
			</td>					
		</tr>
			...
			<tr>
				...
				<td class="wdthpercent50">
					 <span class="">
						...
						<input type="hidden" value="1" name="project_user_type">
					</span>
					<span class="pL40">
	...
	<form action="action.php" method="post" id="addprojectforms" name="addprojectforms">	
		<table class="wdthpercent100">
			...
			<tr>
				...
				<td class="wdthpercent50">
					 <?php if(is_array($filterassigneduserJson) && $filterassigneduserJson!=''){?>
					 ...
					 <?php } else { ?>
						No location add yet.Click here to <a href="<?php echo URL_SITE;?>/add-project-location.php">Add Location</a>
					 <?php } ?>
				</td>					
			</tr>			
			...
			<tr>
				...
				<td class="wdthpercent50">
					 <span class="">
						...
						<input type="hidden" value="<?php echo $project_id;?>" name="project_id">
						<input type="hidden" value="1" name="project_user_type">
						<input type="hidden" value="Farmer" name="uploadprojectassignedfarmer">
					</span>
					<span class="pL40">
						<input type="reset" class="button" value="<?php echo $langVariables['form_var']['reset']?>" id="reset">
					</span>
