<form action="action.php" id="updatefrontuserprofile" name="updatefrontuserprofile" method="post">															
	<table class="data-table">	
		<tbody>
			...
			<tr>
				...
				<th>
					<input <?php if(!empty($userDetail['email'])){?>disabled="true"<?php } ?>class="wdthpercent50 inputbox email required" placeholder="Enter your email" name="email" value="<?php if(isset($userDetail['email'])){ echo stripslashes($userDetail['email']); }?>" type="text" id="email" />
				</th>
			</tr>
			...
			<tr>
				...
				<th>
					<select onchange="javascript:if (typeof functionselectUniversalRecord == 'function') {functionselectUniversalRecord('tahsil','village','1');}" class="wdthpercent83 required" id="tahsil" name="tehsil">
			...
			<tr>
				...
				<th>
					<input class="wdthpercent80 inputbox required" type="number" placeholder="Enter your pincode" name="pincode" id="pincode" value="<?php if(isset($userDetail['pincode'])){ echo ($userDetail['pincode']);}?>"/>
				</th>
			</tr>
			...
			<tr>
				...
				<th>
					<input type="submit" value="Submit" name="updatefrontuserprofile" class="button" /> &nbsp;&nbsp;&nbsp;
	...
	jQuery(document).ready(function(){functionselectCountryRecord();jQuery("#password").val('');});
	</script>
</form>